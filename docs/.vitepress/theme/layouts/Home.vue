...
const recentPosts = [
  { title: 'Vue3 入门指南', date: '2024-01-15', category: '前端', link: '/posts/vue3-intro.html' },
  { title: 'JavaScript 异步编程', date: '2024-01-10', category: '前端', link: '/posts/js-async.html' },
  { title: 'TypeScript 基础知识', date: '2024-01-05', category: '前端', link: '/posts/typescript-basics.html' }
]
